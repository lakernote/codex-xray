...
- Added a daily GitHub Releases check with per-version ignore and manual-download actions.
- Removed automatic update downloads, installation, updater artifacts, and signing-secret requirements.
...
- Initial local-first Usage, project/session/turn ledger, execution trace, Provider control, Codex settings, environment diagnosis, themes, and tray shell.
